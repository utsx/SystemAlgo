...
public class BestFS implements Search {
    ...
    public void search(Graph graph, String from, String to) {
        bestFS(graph, from, to);
        searchPath(from, to);

    }

    public void bestFS(Graph graph, String from, String to) {
        Comparator<String> comparator = (o1, o2) -> (int) (graph.getHeuristicMap().get(o1) - graph.getHeuristicMap().get(o2));
